...
static const char *log_event_str[numRecordReplayWrappers+1] = {
...
void print_log_entry_fcntl(int idx, log_entry_t *entry) {
  ...
  printf(", fd=%d, cmd=%d, arg_3_l=%ld, arg_3_f=%p\n",
         ...
         (long) GET_FIELD_PTR(entry, fcntl, arg),
...
void (*print_log_entry_fn[numRecordReplayWrappers+1])(int, log_entry_t*) = {
